                ...
                isEditorOpen ? (
                    ...
                    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                        <div className="bg-white rounded-lg p-6 max-w-lg mx-auto shadow-lg relative">
                            ...
                            <button className="font-montserrat absolute top-3 right-3  border rounded-full cursor-pointer px-2  inline-flex items-center" onClick={() => setViewModalOpen(false)}>
                                X
                            </button>
                            <div className="flex justify-around">
                                <button className="font-montserrat bg-none text-black hover:text-[#f7fff7] rounded-full cursor-pointer inline-flex items-center border py-[7.5px] px-[50px] hover:bg-[#7b2cbf] " onClick={handleImageClickEditorOpen}>
                                    Edit
                                </button>
                                <button className="preview-button" onClick={handelSelectTemplate}>
                                    Select
                                </button>
                            </div>
                        </div >
