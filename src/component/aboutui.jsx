          ...
          <div className="row justify-center items-center">
            <div className="col-sm-6 pr-10">
              ...
              <p className="text-medium text-black mt-3 text-sm md:text-lg text-justify">
                ...
                strategic planning to offer exceptional digital marketing
                solutions. Our approach blends creative thinking with
                cutting-edge technology to craft effective marketing strategies
                that drive results. By integrating these elements, we deliver
                high-quality services that cater to our clients' unique needs
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(-65deg, #f9f9f9 74%, transparent 74%)",
              }}
            >
