...
/>
      <div className="hsyw p-0">
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <TabGroup>
      <TabList>
        <Tab className="text-md border  border-blue-600 p-2 text-red-600 " onClick={()=>setTelectedteptab("All Templates")}> All Templates</Tab>
        <Tab className="text-md border border-blue-600 p-2 text-green-600" onClick={()=>{ setTelectedteptab("Saved Templates")
      ...
      {selectedteptab=="All Templates"  && (   <select
        ...
        <div className="h-[70vh] overflow-y-auto">
          {Loading ? (
            ...
            <JoditEditor
              ...
              onChange={(newContent) => setSelectedTemplateContent(newContent)}
            />
          )}
